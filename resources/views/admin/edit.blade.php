  ...
  <div class="col-12 col-md-8">
       <div class="app-card app-card-settings shadow-sm p-4">
               ...
               <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{route('employes.update', $employer->id)}}">
                         @csrf
                         @method('Put')
                         <div class="mb-3">
...
<circle cx="8" cy="4.5" r="1"/>
                         ...
                         <div class="mb-3">
                              ...
                              <input type="email" class="form-control" id="setting-input-3" name="email" value="{{$employer->email}}" placeholder="Entrer l'Email">
                              @error('email')
                                  <span class="text-danger">{{$message}}</span>
                              @enderror
                          </div>
                          ...
                          <div class="mb-3">
                              ...
                              <input type="number" class="form-control" id="setting-input-3" name="montant_journalier" value="{{$employer->montant_journalier}}" placeholder="Entrer le montant journalier">
