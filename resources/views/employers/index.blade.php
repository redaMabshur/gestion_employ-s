							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
												...
												<td class="cell"><span class="badge bg-success">{{$employer->montant_journalier *30}} Mad</span></td>
												<td class="cell">
													<a class="btn-sm app-btn-secondary" href="{{route('employers.edit',$employer->id)}}">Editer</a>
													<a class="btn-sm app-btn-secondary" href="{{route('employes.delete',$employer->id)}}">Retirer</a>
												</td>
                                                       </tr>	
                                                       @empty
                                                       <tr>
