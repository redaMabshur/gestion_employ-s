...
<div class="row g-4 settings-section">
  <div class="col-12 col-md-4">
       ...
       <div class="section-intro">Ajouter ici un nouveau employe</div>
  </div>
  <div class="col-12 col-md-8">
       <div class="app-card app-card-settings shadow-sm p-4">
               
               <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{route('employes.store')}}">
                         @csrf
                         @method('POST')
                         <div class="mb-3">
...
<circle cx="8" cy="4.5" r="1"/>
                         ...
                         <div class="mb-3">
                              ...
                              <input type="email" class="form-control" id="setting-input-3" name="email" value="{{old('email')}}" placeholder="Entrer l'Email">
                              @error('email')
                                  <span class="text-danger">{{$message}}</span>
                              @enderror
                          </div>
                          <div class="mb-3">
                              ...
                              <input type="text" class="form-control" id="setting-input-3" name="contact" value="{{old('contact')}}" placeholder="Entrer le contact">
                              @error('contact')
                                  <span class="text-danger">{{$message}}</span>
                              @enderror
                          </div>
                          <div class="mb-3">
                              ...
                              <input type="number" class="form-control" id="setting-input-3" name="montant_journalier" value="{{old('montant_journalier')}}" placeholder="Entrer le montant journalier">
