     ...
     <div class="sidepanel-inner d-flex flex-column">
          ...
          <div class="app-branding">
              <a class="app-logo" href="index.html">
               <img class="logo-icon me-2" src="https://ui-avatars.com/api/?name={{ appNameGetter::getAppName() ? appNameGetter::getAppName(): 'PORTAL' }}" style="border-radius: 50%">
                    <span class="logo-icon me-2">{{ appNameGetter::getAppName() ? appNameGetter::getAppName(): 'PORTAL' }}</span></a>
               </a>
          </div><!--//app-branding-->  
