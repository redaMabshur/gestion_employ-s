...
class SendEmailToAdminAfterRegistrationNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
                    ...
                    ->line('Bonjour')
                    ->line('Votre compte à été crée avec succes sur la plateforme de 
                    gestion de salaire et d\'employé ')
                    ->line('Cliquer sur le bouton ci-dessous pour valider votre compte')
                    ->line('Saisissez le code ' . $this->code . 
                    ' et renseigner le dans le formulaire qui apparaitra lorsque vous cliquerez sur le bouton ci dessous')
